  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "premium-gradient": "var(--gradient-primary)",
        "gold-gradient": "var(--gradient-gold)",
        "subtle-gradient": "var(--gradient-subtle)",
        "emerald-gold-gradient": "var(--gradient-emerald-gold)",
        "card-gradient": "var(--gradient-card)",
        "surface-gradient":
          "linear-gradient(180deg, rgba(255, 255, 255, 0.8) 0%, rgba(255, 255, 255, 0.5) 100%)",
      },
      keyframes: {
        fadeIn: {
          "0%": { opacity: "0" },
