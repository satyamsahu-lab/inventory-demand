        ...
        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-5 space-y-4">
          ...
          <div className="pt-2 border-t border-surface-100 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 text-[hsl(var(--primary))] hover:text-[hsl(var(--primary)/0.8)] font-black text-[11px] uppercase tracking-widest transition-colors"
            >
              <Download size={14} />
              Download Sample
            </button>
